<%-- 
    Document   : roleusertype
    Created on : 25-sep-2015, 21:43:26
    Author     : Developer
--%>
                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        ...
                        <div class="widget-body">
                            ...
                            <!-- BEGIN FORM-->
                            <form action="RoleUserTypeCtrl" method="post" lass="form-horizontal">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea class="input-xxlarge" name="descripcion" rows="3"></textarea>
