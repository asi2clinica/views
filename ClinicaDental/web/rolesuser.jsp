<%-- 
    Document   : rolesuser
    Created on : 27-sep-2015, 13:10:17
    Author     : Developer
--%>
                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i> Mantenimiento de Roles de Usuario</h4>
                            <span class="tools">
                        ...
                        <div class="widget-body">
                            ...
                            <!-- BEGIN FORM-->
                            <form action="RoleUserCtrl" method="post" class="form-horizontal">
								...
								<div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select class="input-medium m-wrap" name="tipoRol" id="tipoRol" tabindex="1">
                                            <option value="Category 1">Temporal</option>
                                            <option value="Category 2">Permanente</option>
                                        </select>
                                    </div>
                                </div>
								<div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select class="input-smamediumll m-wrap" name="permisos" id="permisos" tabindex="1">
                                            <option value="Category 1">Administrador</option>
                                            <option value="Category 2">Secretaria</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea class="input-xxlarge" name="descripcion" id="descripcion" rows="3"></textarea>
